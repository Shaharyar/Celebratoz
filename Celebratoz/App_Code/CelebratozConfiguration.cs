...
/// <summary>
/// Summary description for CelebratozConfiguration
/// </summary>
public class CelebratozConfiguration
{
...
/// <summary> /// Repository for BalloonShop configuration settings /// </summary> public static class BalloonShopConfiguration {  // Caches the connection string  private static string dbConnectionString;  // Caches the data provider name   private static string dbProviderName;
  static CelebratozConfiguration()  
  {
      dbConnectionString = ConfigurationManager.ConnectionStrings["Celebratoz"].ConnectionString;
      dbProviderName = ConfigurationManager.ConnectionStrings["Celebratoz"].ProviderName;
